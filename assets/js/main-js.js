...
import { SellItems } from "../../components/sellItems/SellItems.js";
...
const Banner_Text = [
  "“Olly's Pretzel Thins are a game-changer on the snacking scene. We're impretzed!”",
...
(function () {
    ...
    if (!customElements.get("the-element")) {
        window.customElements.define("the-element", SellItems);
    }
    const bascket = document.querySelector(".bask");
    const sellbascket = document.querySelector(".sell-bascket");
    bascket.addEventListener('click', (event) => {
        sellbascket.style.display = "flex";  
    })
